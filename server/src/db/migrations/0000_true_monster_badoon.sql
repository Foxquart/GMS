...
CREATE TYPE "public"."movement_type" AS ENUM('PURCHASE', 'JOB_USAGE', 'TRANSFER_IN', 'TRANSFER_OUT', 'RETURN', 'DAMAGE', 'ADJUSTMENT');--> statement-breakpoint
CREATE TYPE "public"."job_status" AS ENUM('RECEIVED', 'INSPECTION', 'IN_PROGRESS', 'READY', 'COMPLETED', 'CANCELLED');--> statement-breakpoint
...
ALTER TABLE "job_labour" ADD CONSTRAINT "job_labour_job_id_service_jobs_id_fk" FOREIGN KEY ("job_id") REFERENCES "public"."service_jobs"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "job_parts" ADD CONSTRAINT "job_parts_job_id_service_jobs_id_fk" FOREIGN KEY ("job_id") REFERENCES "public"."service_jobs"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "service_jobs" ADD CONSTRAINT "service_jobs_vehicle_id_vehicles_id_fk" FOREIGN KEY ("vehicle_id") REFERENCES "public"."vehicles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "invoice_items" ADD CONSTRAINT "invoice_items_invoice_id_invoices_id_fk" FOREIGN KEY ("invoice_id") REFERENCES "public"."invoices"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "invoices" ADD CONSTRAINT "invoices_job_id_service_jobs_id_fk" FOREIGN KEY ("job_id") REFERENCES "public"."service_jobs"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_vehicles_registration" ON "vehicles" USING btree ("registration_number");--> statement-breakpoint
...
CREATE INDEX "idx_service_jobs_job_number" ON "service_jobs" USING btree ("job_number");--> statement-breakpoint
CREATE INDEX "idx_service_jobs_status" ON "service_jobs" USING btree ("status");--> statement-breakpoint
CREATE INDEX "idx_service_jobs_customer_id" ON "service_jobs" USING btree ("customer_id");--> statement-breakpoint
CREATE INDEX "idx_service_jobs_vehicle_id" ON "service_jobs" USING btree ("vehicle_id");--> statement-breakpoint
